...
public class ProductoController {
    ...
    @Operation(summary = "Search product by nombre")
    public List<Producto> getProductoLike (@PathVariable String nombre){
        return productoService.findProductoLike(nombre);
    }
